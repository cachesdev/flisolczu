 ...
 *
 * Uso (package.json):
 *   "db:pull": "NODE_OPTIONS='--import tsx' pnpm exec dotenvx run -f .env.development -- tsx scripts/pull-schema.ts"
 */
...
const OVERRIDES: Record<string, Override> = {
	// 'contribuyente.estado': { type: 'ContribuyenteEstado', importFrom: './enums' },
	// 'errorCliente.estado': { type: 'ErrorClienteEstado', importFrom: './enums' }
	// Agregar más según sea necesario:
	// 'estadoCorreo.estado': { type: 'EstadoCorreo', importFrom: './enums' },
	// 'transaccionDocumento.tipoEvento': { type: '"cancelacion" | "inutilizacion"' },
};
