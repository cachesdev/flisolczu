...
<svelte:head>
	...
	<meta
		name="description"
		content="Festival Latinoamericano de Instalación de Software Libre - Cumbre Estudiantil de Código Abierto 2026 en Caaguazu. Un día para aprender, compartir y construir comunidad alrededor del software libre."
	/>
</svelte:head>
